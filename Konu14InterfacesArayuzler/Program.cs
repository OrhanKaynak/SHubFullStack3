namespace Konu14InterfacesArayuzler
{
    ...
    interface icerebilecekleri : IDemo // interface başka interfacelerden miras alabilir.
    {
        // bu interface i kullanacak classlar aşağıdaki varlıkları kullanmak zorundadır.
