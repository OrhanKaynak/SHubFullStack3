namespace Konu10StringSinifi
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string degisken;
            char karakter = 'a';
            string metinlericin = "yan yana karakterlerden oluşan metin";
            //Ornek1();
            //StringMetotlari();
            SplitMetodu();
        }
        static void Ornek1()
        {
            ...
            {
                Console.WriteLine(s[i]); // s değşkeninin i. indexindeki değerini yazdır.
            }
        ...
        static void StringMetotlari()
        {
            ...
            var klon = metin.Clone(); //Clone metodu metin değişkenini klonlayıp klon değişkenine atar.
            ...
            Console.WriteLine("metin.ToUpper: " + metin.ToUpper().Replace("", "-")); //metni küçük harfe çevir ve içindeki boşlukları - ile değiştir.
