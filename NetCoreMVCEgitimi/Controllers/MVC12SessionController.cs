    ...
    public class MVC12SessionController : Controller
    {
        ...
        public IActionResult SessionOlustur(string kullaniciAdi, string sifre)
        {
            ...
            if (kullanici != null)
            {
                ...
                HttpContext.Session.SetString("kullanici", kullaniciAdi); // session da sting olarak key value şeklinde değer saklayabiliriz.
        ...
        {
            HttpContext.Session.Remove("deger"); // deger isimli actionı süresini beklemeden sil
