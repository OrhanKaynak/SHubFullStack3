...
namespace NetCoreMVCEgitimi.Controllers
{
    public class MVC15FiltersUsingController : Controller
    {
        ...
        [UserControl]
        [Authorize] // .net ile aşağıdaki metodu korumaya alıyoruz. Bu metoda sadece login olan kullanıcılar erişebilir.
        ...
        public IActionResult Login(Uye uye)
        {
            ...
            if (kullanici != null)
            {
                ...
                {
                    return Redirect(Request.Query["ReturnUrl"]); // oturrum açıldıktan sonra kullanıcıyı kaldığı yere döndürmek için returnurl deki adrese yönlendir
                }
