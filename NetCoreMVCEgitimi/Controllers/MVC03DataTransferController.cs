...
namespace NetCoreMVCEgitimi.Controllers
{
    public class MVC03DataTransferController : Controller
    {
        ...
        {// 3 Farklı Yöntemle Controllerdan View a Basit Veriler Gönderebiliriz
            ...
            ViewBag.UrunKategorisi = "Bilgisayar"; // Burada ViewBag ismi standart olarak yazılır sonrasında . deyip dilediğiniz değişken adını yazabilirsiniz. 
        ...
        {
            ViewBag.GetVerisi = txtAra; // querystring deki txtAra yapısının değerini getirir.
            return View();
        }
        [HttpPost] // aşağıdaki metod view dan gelecek post isteğinde çalışır, get de çalışmaz!
