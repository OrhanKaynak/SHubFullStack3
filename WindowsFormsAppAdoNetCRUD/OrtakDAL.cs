...
namespace WindowsFormsAppAdoNetCRUD
{
    ...
    {
        internal SqlConnection _connection = new SqlConnection(@"server=(localdb)\MSSQLLocalDB;database=WindowsFormsAppAdoNetCRUD;Integrated Security=True;"); // veritabanımızın bulunduğu server bilisini connection string olarak burada tanımlıyorum
        ...
        public DataTable GetDataTable(string sqlSorgu)
        {
            ...
            ConnectionKontrol(); // veritabanı kapalıysa açacak metot

            SqlCommand command = new SqlCommand(sqlSorgu, _connection); // serverda sql sorgusu çalıştıracak nesne
